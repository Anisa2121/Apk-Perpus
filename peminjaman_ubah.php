        ...
        <form method="post">
            ...
            $id = $_GET['id'];
                if (isset($_POST['submit'])){
                    ...
                    $query = mysqli_query($koneksi, "UPDATE peminjam set id_user='$id_user', id_buku='$id_buku', tanggal_peminjam='$tanggal_peminjam', tanggal_pengembalian='$tanggal_pengembalian', status_peminjam='$status_peminjam' WHERE id_peminjam=$id");
